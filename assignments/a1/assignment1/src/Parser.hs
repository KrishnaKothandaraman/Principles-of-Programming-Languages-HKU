...
happyExpList = Happy_Data_Array.listArray (0,60) ([17664,10240,32770,1,0,4480,4096,0,8,0,69,552,384,35328,20480,4,67,0,0,16640,2048,16386,16,130,512,4096,32768,0,0,0,0,0,0,0
	])

{-# NOINLINE happyExpListPerState #-}
happyExpListPerState st =
    token_strs_expected
  where token_strs = ["error","%dummy","%start_parser","AExpr","NExpr","MExpr","Factor","Primary","digits","'+'","'-'","'*'","'/'","'^'","'('","')'","'%'","'!'","%eof"]
